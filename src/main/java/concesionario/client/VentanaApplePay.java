...
public class VentanaApplePay extends JFrame {

	private JTextField textField;
	private JPasswordField passwordField;


	public VentanaApplePay(Coche coche) {
		getContentPane().setBackground(Color.WHITE);
		getContentPane().setLayout(null);
		
		JLabel lblNewLabel = new JLabel("ApplePay");
		lblNewLabel.setFont(new Font("Monospaced", Font.PLAIN, 26));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(10, 11, 318, 54);
		getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Id de Apple: ");
		...
		JButton btnNewButton_1 = new JButton("Pagar con ApplePay");
